...
const LoginPage: React.FC = () => {
  return (
    <div className="flex items-center justify-center py-12">
      ...
      >
        <h2 className="text-3xl font-display font-bold text-center text-slate-800 mb-2">Welcome Back!</h2>
        <p className="text-center text-slate-600 mb-8">Let's continue our adventure.</p>
