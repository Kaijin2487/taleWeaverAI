...
export const RocketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.98 14.98 0 00-5.84-2.56m0 0a14.982 14.982 0 01-5.84-2.56M12 12a14.982 14.982 0 015.84-2.56M12 12a14.98 14.98 0 00-5.84 2.56m5.84 2.56a14.98 14.98 0 01-5.84 2.56m0 0a14.98 14.98 0 01-5.84 2.56m5.84-12.82a14.983 14.983 0 01-5.84 2.56M12 3.63a14.983 14.983 0 00-5.84 2.56m11.68 0a14.983 14.983 0 01-5.84-2.56" />
  </svg>
);

export const MagicWandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 15.25m9.75-12.146V8.82a2.25 2.25 0 00.659 1.591l4.096 4.096M12 19.5h.008v.008H12V19.5zm-3-3.75h.008v.008H9v-.008zm6 0h.008v.008h-.008v-.008zm-3 3.75h.008v.008H12v-.008z" />
  </svg>
);
